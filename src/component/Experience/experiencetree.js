    ...
    return (
      <div id = "tree">
        <div className="vr">&nbsp;</div>
                ...
                <span id = "text"> Innovation Enginneer at CIBC - 2017 to 2018</span>
                <div className="my_exlogo">
                  ...
                  <ul  className = "my_exdiscription">
                    ...
                    <li>Query and Analyze facial scanner <span className = "focus">SQL database </span>to observe pattern for research</li>
                    <li>Build IOS prototypes with Swift</li>
                    <li>Play around with advanced tools such as 360 cameras (VR)</li>
                  </ul>
                  </span>
                </div>
                ...
                <span id = "text"> Software Engineering Undergratuate at University of Toronto - 2017 to Now </span>
                <div className="my_exlogo">
                <img src={uoft} alt = ""/>
                <br/>
                <span>
                <ul  className = "my_exdiscription">
                <li> - Study <span className = "focus">multiple Basic Programming Language and algorithms</span></li>
                <li> - Participate and Contribute in <span className = "focus">group projects and hackathons</span></li>
                <li> - Exploration in different field</li>
